...
app = Flask(name)
app.secret_key = 'your-secret-key'  # Replace 'your-secret-key' with your own secret key
...
class ParkingSlot:
    def init(self, slot_id, available=True):
...
if name == 'main':
    name = 'main'
    app.run(debug=True, port=8000)Lekshmi:
from flask import Flask, render_template, request, redirect, url_for, session
import datetime
import csv
